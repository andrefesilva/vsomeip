...
void utility::log_network_state(const std::shared_ptr<configuration>& _configuration, bool _tcp, bool _only_external) {
#ifndef __linux__
    (void)_tcp;
    (void)_only_external;
#else
    ...
    auto external_addr = _configuration->get_unicast_address();
