...
// When VSOMEIP_DISABLE_ENV_VARS is defined (set via CMake option VSOMEIP_DISABLE_ENV_VARS),
// a specific subset of environment variable reads are suppressed and always return nullptr.
// This hardens deployments where environment-based configuration overrides are undesirable.
#ifdef VSOMEIP_DISABLE_ENV_VARS
#include <vsomeip/internal/logger.hpp>
#define VSOMEIP_GETENV(name) nullptr
#else
#include <cstdlib>
#define VSOMEIP_GETENV(name) std::getenv(name)
#endif
...
#define VSOMEIP_DEFAULT_PING_TIMEOUT            5000 // ms

#define VSOMEIP_DEFAULT_UDP_RCV_BUFFER_SIZE     1703936

#define VSOMEIP_DEFAULT_IO_THREAD_COUNT         1
...
#define VSOMEIP_REQUEST_DEBOUNCE_TIME           0
...
// wait-on-close for boardnet UDP communication
#define VSOMEIP_UDP_CLOSE_SEND_BUFFER_CHECK_PERIOD  10 // ms
#define VSOMEIP_UDP_CLOSE_SEND_BUFFER_RETRIES       (100 / VSOMEIP_UDP_CLOSE_SEND_BUFFER_CHECK_PERIOD) // Retry for 100ms

// wait-on-close for local communication
#define VSOMEIP_LOCAL_CLOSE_SEND_BUFFER_CHECK_PERIOD  10 // ms
#define VSOMEIP_LOCAL_CLOSE_SEND_BUFFER_RETRIES       (100 / VSOMEIP_LOCAL_CLOSE_SEND_BUFFER_CHECK_PERIOD) // Retry for 100ms
