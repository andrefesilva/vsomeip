...
public:
    offered_services_info_test_client(struct offer_test::service_info _service_info, offer_test::service_info _remote_service_info,
        ...
        app_->request_service(vsomeip::service_t(remote_service_info_.service_id + 1),
                              vsomeip::instance_t(remote_service_info_.instance_id + 1));
        app_->request_service(vsomeip::service_t(remote_service_info_.service_id + 2),
                              vsomeip::instance_t(remote_service_info_.instance_id + 2));
    ...
    void on_offered_services_local(const std::vector<std::pair<vsomeip::service_t, vsomeip::instance_t>>& _services) {
        ...
        app_->get_offered_services_async(
                ...
                std::bind(&offered_services_info_test_client::on_offered_services_remote, this, std::placeholders::_1));
    }
    ...
    void on_offered_services_remote(const std::vector<std::pair<vsomeip::service_t, vsomeip::instance_t>>& _services) {
        ...
        app_->get_offered_services_async(
                vsomeip::offer_type_e::OT_ALL,
                std::bind(&offered_services_info_test_client::on_offered_services_all, this, std::placeholders::_1));
    }
